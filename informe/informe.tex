...
Para calcular la isoterma, al ser  una función discretizada puede no tomar en ninguno de los valores observables el valor exacto de la isoterma a calcular. Para decidir por donde pasara la isoterma lo que vamos a hacer es tomar los dos valores entre los que sabemos  que se encuentra y suponer que entre estos dos radios la temperatura se mueve linealmente. Para ello dividimos la distancia de los radios a tener en cuenta por la diferencia entre las temperaturas que estamos mirando. A esto le multiplicamos la diferencia de la isoterma con el valor mas cercano al borde interno. Ahora calculamos la distancia desde el centro hasta el radio mas cercano al externo y le restamos la diferencia entre 1 y el valor previamente calculado. 
Otras opciones que planteamos fueron tomar de los dos valores el mas próximo al valor de la isoterma y el segundo quedarnos con el mas próximo a la pared externa. Para ello calculamos la diferencia en modulo entre cada uno de los dos puntos en cuestión  con el valor de la isoterma y nos quedamos con el que de un resultado menor.
El segundo caso marcaba un mayor valor en el radio mas cercano a la pared externa que el que realmente tenía (ya que la isoterma tiene un valor mayor a este por ser mas próxima al radio interno). Esto hacia que en caso de correr el riesgo de que el alto horno colapse, seguro que iba a ser visible.
La aproximación del caso elegido nos pareció la mas correcta ya que suponer que la temperatura es lineal entre dos radios es un punto medio entre las opciones descartadas. En los otros casos podemos tomar un valor y que en realidad la isoterma pase por el otro. Con el método elegido siempre quedamos en un punto medio de cuando nos acercamos o nos alejamos mucho del valor real por los otros casos.
